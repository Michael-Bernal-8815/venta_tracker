...
<head>
    ...
    <script type="module" src="../scripts/register.js"></script> <!-- Archivo para manejar el registro -->
</head>
...
<header>
    <div class="header-container">
        ...
        <nav class="navigation">
            <h5>Registrarse.<a href="../pages/index.php#"> para volver haz click aqui. <wbr></a></h5>
        </nav>
    </div>

    <div class="mobile-menu">
        <nav class="navigation">
            <h5>Solo para administradores. Para volver haz click <a href="../pages/index.php#">(Aquí)</a></h5>
        </nav>
    </div>
        ...
        <div class="container-fluid h-custom d-flex justify-content-center align-items-center">
            <div class="container-custom">
                <div class="image-container d-flex justify-content-center align-items-center">
                    <img src="../assets/images/register_draw1.jpg" class="img-fluid" alt="Sample image">
                </div>
                <div class="form-container">
                    <form id="register-form"> <!-- Añadido id para el formulario -->
                        <div class="text-center mb-3">
                            <p class="lead fw-normal mb-0">Regístrate con</p>
                        </div>
